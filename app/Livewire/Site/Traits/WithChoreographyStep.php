...
trait WithChoreographyStep
{
    ...
    public $showLastStepModal = false;
    ...
    {
        if (! $this->selectedChoreographyId) {
            return;
        }
    ...
    public function openLastStepModal()
    {
        $this->showLastStepModal = true;
    }

    /**
     * Fecha o modal de confirmação da última etapa
     *
     * @return void
     */
    public function closeLastStepModal()
    {
        $this->showLastStepModal = false;
    }

    /**
     * Confirma o avanço para a próxima etapa após validações
     *
     * @return void
     */
