...
<div>
    ...
    <div class="flex flex-col md:flex-row  items-start md:items-center justify-start md:justify-between mb-8">
        <div class="mb-6">
            <h2 class="text-xl md:text-2xl font-medium mb-1">Etapa 4: Dançarinos</h2>
            <p class="text-sm">Cadastre todos os dançarinos que participarão do evento.</p>
        </div>
    ...
    {{-- Lista de dançarinos cadastrados responsiva --}}
    <h3 class="text-lg font-semibold mb-4">Dançarinos Cadastrados</h3>
    ...
    @else
        <div class="bg-gray-50 border border-gray-200 rounded-lg p-8 text-center">
            ...
            <p class="text-gray-500">Nenhum dançarino cadastrado ainda</p>
            <p class="text-sm text-gray-400 mt-1">Clique em "Adicionar Dançarino" para começar</p>
        </div>
    @endif
...
{{-- Modal de Adicionar/Editar Dançarino --}}
        <x-mary-modal 
            ...
            title="{{ $isEditingDancer ? 'Editar dançarino' : 'Cadastrar dançarino' }}" 
            class="backdrop-blur"
        ...
        <x-mary-modal wire:model="deleteConfirmModal" title="Confirmar Exclusão" class="backdrop-blur">
            <div class="py-4">
                <div class="flex items-center gap-3 mb-4">
                    ...
                    <div>
                        <p class="text-gray-900 font-medium">Tem certeza que deseja remover este dançarino?</p>
