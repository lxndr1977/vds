...
<div class="">
    ...
    @else
        ...
        @else
            ...
            <div class="z-10 mb-8 md:mb-12 flex justify-center sticky top-0 shadow-sm py-2 md:py-2 w-full bg-zinc-100 border-b border-zinc-100 transition-all duration-300 ease-in">
                    ...
                    @foreach ($steps as $step => $title)
                        <div class="flex flex-col items-center">
                            <button
                                ...
                                class="w-6 h-6 md:w-8 md:h-8 rounded-full flex items-center justify-center text-sm font-medium transition-colors {{ $currentStep >= $step ? 'bg-primary-600 text-white' : 'bg-gray-200 text-gray-600' }} disabled:bg-gray-100 disabled:cursor-not-allowed hover:opacity-80"
                            >
                                {{ $step }}
                            </button>
