...
<div class="w-full bg-secondary-600">
   ...
   <div class="px-4 md:px-6 lg:px-8 py-6 bg-secondary-600 pt-18  text-white">
      <h1 class="mb-4 text-4xl font-bold uppercase text-center ">Inscrições Vem Dançar Sudamérica 2025</h1>
      <p class="text-lg mb-6 text-center">As inscrições estarão abertas de <strong>20 de junho a 14 de setembro de
            2025.</strong> </p>
   </div>

   <div class="py-6">
      <div class="flex justify-center ">
         <div class="max-w-2xl mx-auto space-y-4 bg-white p-8 rounded-lg shadow-md">
            <p>Estão abertas as inscrições para o Vem Dançar Sudamérica 2025! Será um prazer contar com a participação
               do seu Grupo/Escola/Cia nessa edição.</p>
            <p>Antes de iniciar a inscrição, recomendamos que você leia o Regulamento e que tenha em mãos as informações
               que serão solicitadas no formulário.</p>
   ...
   <div class="px-4 md:px-6 lg:px-8 bg-secondary-600 py-12">
